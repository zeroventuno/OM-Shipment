...
export default function Reports() {
    ...
    const exportToExcel = () => {
        ...
        const excelData = dataToExport.map(s => ({
            ...
            [t('Profit')]: `€ ${(s.profit || 0).toFixed(2)}`,
            [t('Savings')]: `€ ${(s.savings || 0).toFixed(2)}`,
    ...
    const handlePrint = () => {
        ...
        dataToExport.forEach(s => {
            ...
            printWindow.document.write(`<td>€ ${(s.profit || 0).toFixed(2)}</td>`);
            printWindow.document.write(`<td>€ ${(s.savings || 0).toFixed(2)}</td>`);
            printWindow.document.write('</tr>');
        });
